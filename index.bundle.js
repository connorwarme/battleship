        ...
        for (let j = 0; j < board[i].length; j++) {
            ...
            if (boolean) {
                ...
                gridCell.addEventListener('click', (e) => {
                    console.log(_gameloop__WEBPACK_IMPORTED_MODULE_1__["default"].getTurn());
