...
const computer = () => {
    const ai = (0,___WEBPACK_IMPORTED_MODULE_0__.playerFactory)('Easy AI');
    const _generate = () => Math.floor(Math.random() * 10);
    const _generateRandomAttack = () => {
        let x = _generate();
        let y = _generate();
